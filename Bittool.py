...
ctypes.windll.kernel32.SetConsoleTitleW("BitTool")
...
while True:
    print(banner)
    print(f"""\n{Fore.BLUE}[1]{Fore.RESET} Delete Webhook
{Fore.BLUE}[2]{Fore.RESET} VC Lagger
{Fore.BLUE}[3]{Fore.RESET} Fast Token Checker
{Fore.BLUE}[4]{Fore.RESET} Mass Report [Not Done]
{Fore.BLUE}[5]{Fore.RESET} Token rape
{Fore.BLUE}[6]{Fore.RESET} 2K Characters Bypass            
{Fore.BLUE}[7]{Fore.RESET} Block Bypass
{Fore.BLUE}[8]{Fore.RESET} Mass DM Friends
{Fore.BLUE}[9]{Fore.RESET} Token Grabber [Python]
{Fore.BLUE}[10]{Fore.RESET} Hypesquad Changer
{Fore.BLUE}[11]{Fore.RESET} Webhook Spammer
{Fore.BLUE}[12]{Fore.RESET} Token login
{Fore.BLUE}[13]{Fore.RESET} Raiding Tools
{Fore.BLUE}[14]{Fore.RESET} Token Information
